...
#source DefEvalCfg.ksh
MEC_valid_date1=20220801
MEC_valid_date2=20220805
MEC_per_type="CUSTOM"

# The name of the evaluation, an ID (will be a subdir of the directory below)
MEC_eval_name="REG21T-test"  # Nome para a avaliação
MEC_ref_per="202208"    # Nome para o período de referencia

# Where all files wrt this evaluation are stored
MEC_D_data=/dados/dmdpesq/roberto.garcia/MEC_DATA
#MEC_D_data=/dados/ensemble/dsk001/MEC_DATA
...
#MEC_D_mec=/scripts/ensemble/MEC-DEV
MEC_D_mec=/home/roberto.garcia/ProjDocs/Projects/MEC/MEC-PRE
...
#MEC_D_common=/scripts/ensemble/MEC-DEV/CommonData
...
# =====================================================
# Creating a R script with the exactly definitions above
# =====================================================
fname_r=EVAL_SET.R
echo "# ======================================================="    >  ${fname_r}
