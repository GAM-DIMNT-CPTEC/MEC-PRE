...
export MEC_eval_mode=1

#./03-Eval.ksh ${MEC_eval_name} ${MEC_eval_mode}
# Estes dois scripts devem ser executados na primeira vez para determinar a região de avaliação e a forma de avaliação
#Rscript REG21T-test/01-CFG_Main.R
#Rscript REG21T-test/04-CFG_SET_TMIN_SAMeT.R
...
Rscript 07-JoinPER.R ${MEC_eval_name} ${MEC_var} ${MEC_init_time}
